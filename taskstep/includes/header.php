...
<div id="container">
  ...
  <nav class="navbar navbar-expand-lg sticky-top" id="headernav">
    <div class="container-fluid">
      ...
      <a class="navbar-brand d-flex align-items-center" href="index.php">
        <img src="images/icon.png" alt="TaskStep Icon" width="30" height="30"
          class="d-inline-block align-text-top me-2">
        TaskStep <span class="subtitle ms-1">1.1</span>
      </a>

      <!-- Toggler for mobile -->
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTaskstep"
        aria-controls="navbarTaskstep" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="display.php?display=today&amp;sort=done">
              <img src="images/calendar_view_day.png" alt="Calendrier" class="me-1" />
              <?php echo $l_nav_today; ?>: <?php echo date($_SESSION["menu_date_format"]); ?>
            </a>
          </li>
          <li class="nav-item"><a class="nav-link" href="index.php"><img src="images/house.png" alt="Maison"
                class="me-1" /><?php echo $l_nav_home; ?></a></li>
          <li class="nav-item"><a class="nav-link" href="display.php?display=all&amp;sort=date"><img
                src="images/page_white_text.png" alt="Feuille remplie de texte"
                class="me-1" /><?php echo $l_nav_allitems; ?></a></li>
          <li class="nav-item"><a class="nav-link" href="display_type.php?type=context"><img src="images/context.png"
                alt="Tableau ressemblant a une feuille excel" class="me-1" /><?php echo $l_nav_context; ?></a></li>
          <li class="nav-item"><a class="nav-link" href="display_type.php?type=project"><img src="images/project.png"
                alt="Dossier" class="me-1" /><?php echo $l_nav_project; ?></a></li>
          <li class="nav-item"><a class="nav-link" href="settings.php"><img src="images/textfield_rename.png"
                alt="Champ textuel" class="me-1" /><?php echo $l_nav_settings; ?></a></li>
          <li class="nav-item"><a class="nav-link" href="http://www.cunningtitle.com/taskstep"><img
                src="images/help.png" alt="Point d'interrogation" class="me-1" /><?php echo $l_nav_help; ?></a></li>
          <li class="nav-item"><a class="nav-link" href="login.php?action=logout"><img src="images/door_in.png"
                alt="Porte ouverte" class="me-1" /><?php echo $l_nav_logout; ?></a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="container-fluid ">
    <div class="row">
          ...
          <?php foreach ($results as $result): ?>
            ...
            <li class="nav-item">
              <a class="nav-link <?= $title ?>"
                href="display.php?display=section&amp;section=<?= urlencode($result->getTitle()) ?>&amp;sort=date&tid=<?= $result->getId() ?>">
                <?= $label ?>
      ...
      <button class="btn d-md-none my-2 ms-3" type="button" data-bs-toggle="offcanvas"
